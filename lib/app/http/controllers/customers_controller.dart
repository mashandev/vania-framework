...
class CustomersController extends Controller {
  ...
  Future<Response> create(Request request) async {
    return Response.json({'message': 'Form membuat customers baru'});
  }
  ...
  Future<Response> update(Request request, int id) async {
    try {
      ...
      request.validate({
        ...
        'cust_zip.numeric': 'Zip Customers harus berupa teks',
        ...
        'cust_telp.numeric': 'Telp Customers harus berupa teks',
